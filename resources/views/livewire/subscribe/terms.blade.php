    ...
    <section class="blog2 section-padding" style="min-height: 91vh">
        <div class="container">
            <div class="row">
                ...
                {{-- pageTitle --}}
                <div class="col-12">
                    <div class="section-title text-center mb-4">Terms and Conditions</div>
                </div>
                ...
                <div class="col-12 d-none">
                    <div class="terms--wrapper">
                        ...
                        {{-- section --}}
                        <h3>General Terms</h3>
                        <p class="term--point">Meals are intended for the next day or should be consumed on the same
                            day
                            they
                            are delivered</p>

                        <p class="term--point">The driver' s waiting time at the agreed delivery location is 10
                            minutes
                            from the time of arrival. If the customer does not respond to the call, the meals will
                            be stored at the nearest {{ env('APP_CLIENT_NAME') }} branch</p>
                        ...
                        <p class="term--point">Customers may cancel within the first 5
                            days of the meal plan. The unused balance will be refunded, minus a 200 AED
                            cancellation
                        ...
                        <p class="term--point">Each confirmed and paid referral earns a free snack on the
                            client's next
                            renewed
                            plan</p>
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>Allergen Policy</h3>
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>Refund & Cancellation Policy</h3>
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>Delivery Policy</h3>
                        ...
                        <p class="term--point">All deliveries will be made in thermal
                            ...
                            required for the cooler bags. This will be refunded at the end of the subscription
                            upon
                            the return of all bags in good condition to ensure consistency with Clause No. 6
                            related
                        ...
                        <p class="term--point">Deliveries will be placed at the client's
                            doorstep during the agreed delivery time window. Clients must leave the empty cooler
                            bag
                        ...
                        <p class="term--point">There is no delivery on Saturdays. Friday delivery will include
                            two meal
                        ...
                        <p class="term--point">Please note that the bag is considered an
                            ...
                            the client cancels the subscription Kindly ensure this policy is applied when
                            processing
                        ...
                        <p class="term--point">{{ env('APP_CLIENT_NAME') }} reserves the
                            right to change or
                            modify these Terms and Conditions at any time without prior notice. Your continued
                            use
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>General Privacy Policy</h3>

                        <p class="term--point">{{ env('APP_CLIENT_NAME') }} values your
                            privacy and is
                            committed to protecting your personal information. For more details, please review
                            our
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>Use of the Website</h3>
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>Products and Services</h3>
                        ...
                        <p class="term--point">Subscription changes (upgrades, downgrades) must be settled
                            within 3
                            business days</p>
                        ...
                        <h3 class='mt-5'>Meal Selection Policy</h3>

                        <p class="term--point">To maintain a consistent quality of
                            service and streamlined operations, all meal selections must be made exclusively
                            through
                        ...
                        {{-- section --}}
                        <h3 class='mt-5'>Health Disclaimer</h3>
                ...
                <div class="col-12">
                    <div class="terms--wrapper privacy--wrapper">
                        ...
                        {{-- termsAndConditions --}}
                        @if ($websiteSettings?->termsAndConditions)

                        {!! $websiteSettings?->termsAndConditions !!}
